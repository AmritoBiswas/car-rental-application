...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/customerAdminPage")}}" class="side-bar-item">
        <i class="bi bi-people"></i>
        <span class="side-bar-item-caption">Customer</span>
    </a>

    <a href="{{url("/allRent")}}" class="side-bar-item">
        <i class="bi bi-list-nested"></i>
        <span class="side-bar-item-caption">All Rents</span>
    </a>

    <a href="{{url("/carListAdmin")}}" class="side-bar-item">
        <i class="bi bi-bag"></i>
        <span class="side-bar-item-caption">All Cars</span>
    </a>
