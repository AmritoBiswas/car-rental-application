        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <div>
                    ...
                    <button onclick="deleteProduct()" type="button" id="confirmDelete" class="btn bg-gradient-danger" >Delete</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
     async function deleteProduct(){
        ...
        // showLoader();
        let res=await axios.post("/delete-car",{id:id,filePath:deleteFilePath})
        hideLoader();
